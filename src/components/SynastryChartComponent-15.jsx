...
const SynastryChartComponent = ({
  ...
  useEffect(() => {
    ...
    const drawHouses = (houses, refAsc,
      ...
      numR, numColor,
      labelR, labelColor) => {
      Object.entries(houses).forEach(([hNum, h]) => {
    ...
    if (chart2.houses) drawHouses(
      ...
      R_P2_IN * 0.1, R_P1_IN,        // regular house lines
      // R_P2_IN, R_P2_TRACK,           // angle house lines
      R_P2_TRACK, R_P1_IN,
      '#553333', '#880000',          // lineColor, angleColor
      R_P2_IN * 1.1, '#664444',      // numR, numColor
      R_P2_IN + 14 * fs, '#880000'   // labelR, labelColor
    );
    ...
    drawRing(chart2.planets, R_P2_TRACK, R_P1_IN, '#cc2222', '#ffffff', '#cc2222', false);
